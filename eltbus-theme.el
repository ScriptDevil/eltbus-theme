...
(let ((black  "#000000")
  ...
  (let ((default-color `(:background ,black :foreground ,text-white))
	(brighter `(:background ,black :foreground "#ccccff"))
	(lessbright `(:background ,black :foreground "##9999d6"))
	(standout-dull `(:background ,bright-black :foreground ,dull-white))
	(sharp `(:background "#000a1f" :foreground "#b8a094"))
	(less-distraction `(:background ,black :foreground "#ddaa99"))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-string-face ((t (,@sharp ,@fmt-none))))
